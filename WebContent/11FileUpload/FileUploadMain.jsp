...
<body>
	...
	<form action="UploadProc" method="post" name="filefrm"
		onsubmit="return isValidated(this)" enctype="multipart/form-data">
		
		작성자 : <input type="text" name="name" value="Malena">
		<br>
		...
		관심사항 :
			...
			<input type="checkbox" name="inter" value="문화" checked="unchecked">문화
		<br>
		첨부파일1 : 
	...
	<form action="UploadProc2.jsp" method="post" name="filefrm2" 
		...
		작성자 : <input type="text" name="name" value="Nino" />
		<br />
		제목 : <input type="text" name="title" value="" />
		<br />
		관심사항 : 
