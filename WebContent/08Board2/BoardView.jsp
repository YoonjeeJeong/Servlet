		...
		<div class="col-9 pt-3">
			...
			<div class="row mt-3 mr-1">
				...
				<tbody>
					...
					<tr>
						...
						<%-- 
						textaread에서 엔터키로 줄바꿈을 한 후 db에 저장하면 \r\n으로 저장되므로,
						html페이지에서 출력할때는 <\br>태그로 문자열을 변경해야한다.
						--%>
			...
			<div class="row mb-3">
				...
				%>
					...
					<!-- 회원제 게시판에서 삭제처리는 별도의 폼이 필요없이, 사용자에 대한
					인증처리만 되면 즉시 삭제처리한다 -->
			...
			<!-- 
			게시물 삭제의 경우 로그인 된 상태이므로 해당 게시물의 일련 번호만
