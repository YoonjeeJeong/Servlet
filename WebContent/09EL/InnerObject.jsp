...
<body>
<!-- 
EL에서 각 영역에 저장된 속성을 읽을때는 xxxScope계열의 내장객체를
사용한다. xxxScope.속성명 혹은 xxxScope['속성명'] 형태로 읽어올 수 있고,
속성명이 유일할때는 내장객체를 생략할 수 있다. 만약 속성명이 동일하면
가장 좁은 영역의 속성을 읽어온다. 
 -->
	<h2>EL태에서 내장객체 사용하기: xxxScope계열</h2>
	...
	<ul>
		<li>가장 좁은영역 읽음: ${scopeVar }</li>
		<li>위처럼 영역부분을 생략한 후 EL로 읽게되면 가장 좁은 영역인 page영역이 읽혀지게 된다.</li>
	</ul>
	<%--아래를 주석으로 처리하면 페이지 영역이 읽힌다. 하지만 포워드 된 페이지에서는 안 읽힌다. --%>
