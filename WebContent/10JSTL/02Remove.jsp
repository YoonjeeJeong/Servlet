...
<body>
<!-- remove 태그: set으로 선언한 변수를 제거할 때 사용하는 태그
...
<!-- 
 ...
 -->
	...
	<ul>
		<li>페이지 : ${pageVar }</li>
		<li>리퀘스트 1: ${requestScope.pageVar }</li>
		<li>리퀘스트 2: ${requestVar }</li><!-- requestVar중 세션영역에 있는 var는 없다 -->
		<li>세션: ${sessionVar }</li>
		<li>어플리케이션: ${appVar }</li>
	</ul>
	...
	<ul>
		...
		<li>리퀘스트 1: ${requestScope.pageVar }</li><!-- 삭제됨 -->
		<li>리퀘스트 2: ${requestVar }</li>
		<li>세션: ${sessionVar }</li>
		<li>어플리케이션: ${appVar }</li>
	</ul>
