...
<c:import url="/10JSTL/inc/ImportPage.jsp" var="contets">
...
<h3>외부(원격에 있는 내용 삽입하기)</h3>
<iframe src="./inc/ImportNate.jsp" frameborder="1" style="width:100%; height500px;"></iframe>
</body>
</html>