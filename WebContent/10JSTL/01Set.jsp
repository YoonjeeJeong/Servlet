...
set태그 속성
	...
	scope : 영역을 지정. 문자열만 가능하고 4가지 영역을 지저할 수 있음. 
			기본값은 가장좁은 page영역임.
 ...
 -->
	...
	<h3>EL로 출력</h3>
	<!-- 
	EL로 영역의 속성을 읽어올때는 xxxScope를 생략하면 가장 좁은 페이지 영역을 읽어오게 된다.
	즉 아래는 모두 페이지 영역을 읽어오게 된다.
	 -->
	<ul>
	...
	<!-- el로 출력할때는 별도의 형변환이 필요없고, 속성명이 중복되지 않는다면 
