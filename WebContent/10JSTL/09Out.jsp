...
<!-- out태그
 ...
 -->
	...
	<br>
	\${htmlStr} : ${htmlStr }<%--이렇게 출력될거다=> ${htmlStr} :h3태그로 감싼 문자열 --%>
	
	
	<!-- 
	-out태그에 value속성의 값이 null일때는 default속성에 지정한 값이 출력된다
