...
public class WriteCtrl extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		req.setCharacterEncoding("UTF-8");//글쓰기 폼값에 대한 한글처리
		...
		if(mr != null) {
			/*
			 파일업로드가 와료되면 나머지 폼값을 받기위해 mr참조변수를 이용한다.
			 enctype이 multipart/form-data로 설정되므로 request객체를 통해 
			 폼값을 받을 수 잆다
			 */
