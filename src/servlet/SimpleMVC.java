...
public class SimpleMVC extends HttpServlet{
	...
	/*
	 클라이언트의 요청이 get방식이든 post방식이든 하나의 메소드에서 처리하기위해
	 processRequest()메소드로 모든 요청을 전달한다.
	 */
	@Override
	...
	/* doGet()혹은 doPost()의 요청을 그대로 전달받기 위해서는 아래와 같이
	 메소드를 기술해야한다. request, response객체를 매개변수로 사용하고
	...
	private void processRequest(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(type==null) {
			...
			/*
			 서블릿 클래스에서 application내장객체를 사용하기위해
